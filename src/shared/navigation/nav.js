...
export default function Header() {
    ...
    return <header className="flex justify-between items-center px-4 py-4 bg-white shadow-md md:px-8">
        ...
        <nav
            className={`${isOpen ? "block" : "hidden"
                } md:flex md:items-center space-y-4 md:space-y-0 md:space-x-6 absolute md:relative top-16 left-0 w-full bg-white shadow-md md:shadow-none md:top-auto md:w-auto p-4 md:p-0 z-10`}
        >
            ...
            <Link href="/noticia" className="text-gris-o1 hover:text-main transition duration-300">
                Noticias
            </Link>
